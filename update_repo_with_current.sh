...
cp -rf "/Users/kuzmik/Library/ApplicationSupport/Sublime Text 3/Installed Packages" Sublime

# copy over boxy extra addons
cp -rf "/Users/kuzmik/Library/ApplicationSupport/Sublime Text 3/Packages/Boxy Theme Addon - Mono File Icons" Sublime/Packages
cp -rf "/Users/kuzmik/Library/ApplicationSupport/Sublime Text 3/Packages/Boxy Theme Addon - Unified Mode" Sublime/Packages
...
for f in "Package Control.sublime-settings" "Preferences.sublime-settings" "Default (OSX).sublime-keymap"; do
  cp -rf "/Users/kuzmik/Library/ApplicationSupport/Sublime Text 3/Packages/User/$f" Sublime/Packages/User
done
